...
// Componente para verificar si ya esta logueado para no dejar entrar en la parte de login
const VerificateIsLogin = ({ children }) => {
...
export default VerificateIsLogin;
